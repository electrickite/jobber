  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      max_amount = d3.max(this.data, function(d) {
        return parseInt(d.salary_average);
      });
    ...
    BubbleChart.prototype.create_nodes = function() {
      this.data.forEach((function(_this) {
        return function(d) {
          var node;
          var salary = parseInt(d.salary_average);
          node = {
            id: d.id,
            radius: _this.radius_scale(salary),
            value: salary,
            name: d.working_title,
            org: d.department,
            group: d.category,
            year: d.category,
            x: Math.random() * 900,
    ...
    BubbleChart.prototype.display_years = function() {
      ...
      years_x = {
        ...
        "A&P": 260,
        "IT": 550,
        "Research": this.width - 225,
        "Civil Service": this.width - 80
      };
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      content = "<span class=\"name\">University Title:</span><span class=\"value\"> " + data.name + "</span><br/>";
      content += "<span class=\"name\">Department:</span><span class=\"value\"> " + data.org + "</span><br/>";
      content += "<span class=\"name\">Average Salary:</span><span class=\"value\"> $" + (addCommas(data.value)) + "</span><br/>";
      content += "<span class=\"name\">Category:</span><span class=\"value\"> " + data.group + "</span>";
